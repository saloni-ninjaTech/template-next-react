...
function Footer() {
  return (
    <Grid>
  <Grid className="container-fluid bg-dark text-light mt-5 wow fadeInUp" data-wow-delay="0.1s">
    <Grid className="container">
      <Grid className="row gx-5">
        <Grid className="col-lg-4 col-md-6 footer-about">
          <Grid className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
        ...
        <Grid className="col-lg-8 col-md-6">
          <Grid className="row gx-5">
            <Grid className="col-lg-4 col-md-12 pt-5 mb-5">
              <Grid className="section-title section-title-sm position-relative pb-3 mb-4">
                <h3 className="text-light mb-0">Get In Touch</h3>
              </Grid>
              <Grid className="d-flex mb-2">
            ...
            <Grid className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
              <Grid className="section-title section-title-sm position-relative pb-3 mb-4">
  ...
  <Grid className="container-fluid text-white" style={{background: '#061429'}}>
    <Grid className="container text-center">
      <Grid className="row justify-content-end">
        <Grid className="col-lg-8 col-md-6">
          <Grid className="d-flex align-items-center justify-content-center" style={{height: 75}}>
